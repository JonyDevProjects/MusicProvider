...
- 📱 **[Preparación iOS Físico (WiFi y Celular)](./ios-physical-test-prep.md)**: Guía integral para preparar pruebas en iPhone físico bajo WiFi local, WiFi remoto y datos móviles, incluyendo Cloudflare Tunnel y troubleshooting por escenario.
